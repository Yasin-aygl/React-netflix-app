...
const Main = () => {
  ...
  // her seferinde rastgele bir film seç
...
// overview yazısını kısaltmak için kullanacağımız kod
      ...
      <div className="w-full h-full">
        ...
        <div className="absolute w-full top-[20%] p-4 md:p-8">
          ...
          <div className="my-4">
            ...
            <button className="border text-white border-gray-300 py-2 px-5 ml-4 hover:border-white">
              Watch Later
            </button>
          </div>
